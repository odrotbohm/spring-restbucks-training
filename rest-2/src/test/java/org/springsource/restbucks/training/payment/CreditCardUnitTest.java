...
public class CreditCardUnitTest {
	...
	public void discoversExpiredCreditCard() {
		...
		CreditCard creditCard = new CreditCard(NUMBER, "Oliver Gierke", Months.ELEVEN, Years.years(2014));

		assertThat(creditCard.isValid(new LocalDate()), is(true));
		assertThat(creditCard.isValid(new LocalDate(2014, 12, 1)), is(false));
	}
}
